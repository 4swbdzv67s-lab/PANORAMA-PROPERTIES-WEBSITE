export function PhoneIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" {...props}>
      <path
        d="M6.5 3h3l1.5 4.5-2.25 1.5a12 12 0 0 0 6.25 6.25l1.5-2.25L21 14.5v3a2 2 0 0 1-2 2C11.5 19.5 4.5 12.5 4.5 5a2 2 0 0 1 2-2z"
...
export function FacebookIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M14 9h3V5h-3c-2.21 0-4 1.79-4 4v2H7v4h3v7h4v-7h2.6l.7-4H14V9c0-.55.45-1 1-1z" />
    </svg>
  );
}
...
export function LinkedInIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M4.98 3.5C4.98 4.88 3.87 6 2.5 6S0 4.88 0 3.5 1.11 1 2.48 1s2.5 1.12 2.5 2.5zM.5 8h4v13h-4V8zM8.5 8h3.8v1.8h.05c.53-1 1.83-2 3.77-2 4.03 0 4.78 2.65 4.78 6.1V21h-4v-6.6c0-1.6-.03-3.6-2.2-3.6-2.2 0-2.6 1.7-2.6 3.5V21h-4V8z" />
    </svg>
  );
}
...
export function MouseIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 36" fill="none" stroke="currentColor" strokeWidth="1.5" {...props}>
      <rect x="1" y="1" width="22" height="34" rx="11" />
      <rect x="10.5" y="8" width="3" height="8" rx="1.5" fill="currentColor" stroke="none" />
    </svg>
  );
}

export function DiamondIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" {...props}>
...
export function MapPinIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" {...props}>
      <path d="M12 21s7-7.5 7-12a7 7 0 1 0-14 0c0 4.5 7 12 7 12z" strokeLinejoin="round" />
...
export function SofaIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" {...props}>
      ...
      <path d="M4 18v2M20 18v2" strokeLinecap="round" />
    </svg>
  );
}
